...
load figxpwdata_new
figure(2);
plot(P,XP(:,3),'k-',P,XP(:,2),'k--',P,XP(:,1),'k:','linewidth',1.5);
set(gca,'fontsize',14,'xtick',[1050:450:2850],'ytick',[-600,-200:200:1400])
set(gcf,'papersize',[8.5,5.5]);
xlabel('\itP_{t}','fontsize',14)
%ylabel('Net Wealth: W  ($1000)','fontsize',10)
ylabel('\itx_{t}*','fontsize',14)
legend('\itW_{t} = $1,000,000  ', '\itW_{t} = $500,000  ','\itW_{t} = $350,000  ',1)
